...
Add automatically, no confirmation needed.

| Item | Notes |
|---|---|
| Spindrift Sparkling Water, Grapefruit | Only flavor ever ordered — 13/23 orders |
| Pepperidge Farm Goldfish Cheddar Crackers | 14/23 orders |
| Diet Coke Mini Cans | 7/23 orders; often substituted when out of stock |
| Honest Kids juice boxes | Fruit Punch most common; Berry Good Lemonade and Goodness Grapeness are frequent rotating alternates — either is fine |
| Mini Corn Muffins | 16/23 orders — the single most consistent item in the whole history |
| Organic bananas | Near-universal fresh staple |
| Fuji apples (organic where available) | Near-universal fresh staple |
| Driscoll's Blueberries | 13/23 orders |
...
| Kettle-cooked potato chips (Cape Cod / Kettle Brand) | |
| Bounty Paper Towels | |

## Seasonal / occasional — confirm each order, don't auto-add

Ask which of these (if any) to include before adding.
